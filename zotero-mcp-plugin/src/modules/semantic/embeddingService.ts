...
const PREF_API_BASE = "extensions.zotero.zotero-mcp-plus.embedding.apiBase";
const PREF_API_KEY = "extensions.zotero.zotero-mcp-plus.embedding.apiKey";
const PREF_MODEL = "extensions.zotero.zotero-mcp-plus.embedding.model";
...
const PREF_RPM = "extensions.zotero.zotero-mcp-plus.embedding.rpm";
const PREF_TPM = "extensions.zotero.zotero-mcp-plus.embedding.tpm";
const PREF_COST_PER_1M =
  "extensions.zotero.zotero-mcp-plus.embedding.costPer1M";
const PREF_USAGE_STATS =
  "extensions.zotero.zotero-mcp-plus.embedding.usageStats";
